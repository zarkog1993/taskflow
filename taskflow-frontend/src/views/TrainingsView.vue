<template>
    <div class="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div
            class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-800/80 p-5 rounded-2xl border border-gray-700/80 shadow-xl"
        >
            <div>
                <h2 class="text-2xl font-black text-white tracking-tight">
                    Kalendar Treninga i Utakmica
                </h2>
                <p class="text-xs text-gray-400 mt-0.5">
                    Pregled zakazanih aktivnosti po danima i evidencija
                    prisustva
                </p>
            </div>
            ...
            >
                <!-- Promena meseca -->
                <div
                    class="flex items-center bg-gray-900 rounded-xl p-1 border border-gray-700/80"
                >
                    <button
                        @click="changeMonth(-1)"
                    ...
                    <span
                        class="px-3 text-xs font-bold text-white min-w-[110px] text-center capitalize"
                    >
        ...
        <div
            class="bg-gray-800/90 border border-gray-700/80 rounded-2xl p-4 shadow-2xl overflow-x-auto"
        >
            <div
                class="grid grid-cols-7 gap-2 mb-2 text-center text-[11px] font-extrabold uppercase text-gray-400 tracking-wider min-w-[700px]"
            >
                ...
                <div class="py-2 bg-gray-900/60 rounded-lg text-indigo-400">
                    Subota
                </div>
                <div class="py-2 bg-gray-900/60 rounded-lg text-indigo-400">
                    Nedelja
            ...
            <div class="grid grid-cols-7 gap-2 min-w-[700px]">
                <div
                    ...
                    :key="'blank-' + blank"
                    class="min-h-[110px] bg-gray-900/20 rounded-xl border border-gray-800/40 opacity-40"
                ></div>
                ...
                >
                    ...
                    <div
                        class="space-y-1.5 flex-1 overflow-y-auto max-h-[90px] custom-scrollbar"
                    >
                        <div
                        ...
                        >
                            <div
                                class="flex justify-between items-start font-bold"
                            >
        ...
        >
            <div
                class="bg-gray-800 border border-gray-700/80 rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200"
            >
                <!-- Zaglavlje Modala -->
                <div
                ...
                >
                    ...
                    <p class="text-xs text-gray-400 mt-1">
                        Unesite detalje treninga ili utakmice za trenažni
                        mikrociklus
                    </p>
                </div>
                ...
                >
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold uppercase tracking-wider text-gray-400 mb-1.5"
                            >Naslov / Tema Događaja</label
                        >
                        <input
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            >
                                ...
                                <option value="tactical_analysis">
                                    📋 Taktička Analiza
                                </option>
                                <option value="fitness">
                                    🏋️‍♂️ Kondicija / Oporavak
                                </option>
                            </select>
                        </div>
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold uppercase tracking-wider text-gray-400 mb-1.5"
                            >Datum i Vreme Održavanja</label
                        >
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold uppercase tracking-wider text-gray-400 mb-1.5"
                            >Opis i Trenažne Napomene</label
                        >
                        <textarea
                    ...
                    <div
                        class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-700/70"
                    >
                        <button
                            type="button"
                            @click="showCreateModal = false"
        ...
        >
            <div
                class="bg-gray-800 border border-gray-700/80 rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
            >
                ...
                >
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="text-xs text-gray-400 font-medium"
                            >📍
                            {{ activeSession.location || "Glavni Teren" }}</span
                        >
                    </div>

                    <h3
                        class="text-2xl font-black text-white tracking-tight mb-2"
                    >
                        {{ activeSession.title }}
                    </h3>
                    ...
                    <div
                        class="bg-gray-800/80 p-3 rounded-xl border border-gray-700/60 mt-2"
                    >
                        <div
                            class="text-[10px] font-bold uppercase tracking-wider text-indigo-400 mb-0.5"
                        >
                            Opis / Trenažni Cilj:
                        </div>
                        <p class="text-xs text-gray-200 leading-relaxed">
                            {{
                                ...
                                "Nema unetog dodatnog opisa za ovaj događaj."
                            }}
                        </p>
                    </div>
                </div>
                ...
                <div
                    class="p-4 bg-gray-900/60 border-b border-gray-700/60 space-y-3"
                >
                    <div
                    ...
                    >
                        <div class="flex items-center gap-2">
                            <div
                                class="bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 rounded-xl text-xs"
                            >
                            ...
                            <div
                                class="bg-indigo-500/10 border border-indigo-500/20 px-3 py-1.5 rounded-xl text-xs"
                            >
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                ...
                                class="text-[11px] font-bold text-indigo-400 hover:text-indigo-300 bg-indigo-950/60 px-2.5 py-1.5 rounded-lg border border-indigo-800/50 transition"
                            >
                                ✓ Označi sve
                            </button>
                            <button
                                ...
                                class="text-[11px] font-bold text-gray-400 hover:text-white bg-gray-800 px-2.5 py-1.5 rounded-lg border border-gray-700 transition"
                            >
                                ✕ Poništi
                            </button>
                        </div>
                ...
                <div
                    class="p-4 overflow-y-auto space-y-2 flex-1 custom-scrollbar"
                >
                    <div
                        ...
                        :class="[
                            ...
                            selectedAttendeeIds.includes(user.id)
                        ...
                        <div class="flex items-center space-x-3">
                            <img
                                :src="
                                    ...
                                    `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=312e81&color=c7d2fe&size=96`
                                "
                ...
                <div
                    class="p-4 bg-gray-900/80 border-t border-gray-700/80 flex items-center justify-between"
                >
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button
                            ...
                            class="px-5 py-2 text-xs bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl shadow-lg transition"
                        >
                            Sačuvaj Prisustvo
                        </button>
                    </div>
...
const openAttendanceModal = (session) => {
    ...
    selectedAttendeeIds.value = session.attendees
        ? session.attendees.map((a) => a.id)
        : [];
    searchQuery.value = "";
...
const attendancePercentage = computed(() => {
    ...
    return Math.round(
        (selectedAttendeeIds.value.length / userStore.users.length) * 100,
    );
});

const handleSaveAttendance = async () => {
    if (!activeSession.value) return;
    const success = await trainingStore.saveAttendance(
