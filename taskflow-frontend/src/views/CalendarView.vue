<template>
    <div class="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        >
            ...
            <h2
                class="text-base font-bold text-white uppercase tracking-wider capitalize"
            >
        ...
        >
            <div
                class="bg-gray-800 border border-gray-700 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto"
            >
                <div
                ...
                <form @submit.prevent="handleCreateEvent" class="space-y-4">
                    ...
                    >
                        ...
                        <div
                            class="max-h-36 overflow-y-auto space-y-1.5 pr-1 bg-gray-900/80 p-2 rounded-xl border border-gray-700/60"
                        >
                            <div
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold px-4 py-2 rounded-xl transition"
                        >
                            Sačuvaj
                        </button>
                    </div>
